---
title: 웹소켓의 기본 개념과 통신 과정
description: 웹소켓의 개념과 특징, 핸드셰이크부터 연결 종료까지 이어지는 통신 과정을 정리한다.
track: log
created: 2024-09-24T09:38
tags: [websocket, socketio]
---

실시간 채팅 기능을 구현할 수 있는 다양한 통신 방식이 있지만, 그중 가장 보편적으로 사용되는 프로토콜은 **WebSocket**이다.

사실 채팅 기능을 개발해보는 이유도 이 **WebSocket**을 사용해보기 위해서이기도 하다.
