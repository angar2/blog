---
title: 'I am Ironman: 콘텐츠 물리 충돌 처리'
description: Phaser.js Arcade 엔진의 사각형 물리 충돌 한계를 여러 개의 사각형 존으로 극복해, 콘텐츠 형태에 맞는 충돌 감지 영역을 직접 구현한 과정을 정리한다.
track: log
created: 2024-08-19T09:34
tags: [phaser, physics, collision]
sources:
...
![Ironman Collision](/assets/images/blog/34/1.gif)
*물리 충돌 가능 영역(보라색 라인)의 비정상적 충돌*
...
![Ironman Collision](/assets/images/blog/34/2.gif)
*물리 충돌 가능 영역 세분화*
