---
title: Socket.IO 웹소켓 세팅
description: Nest.js 서버와 Next.js 클라이언트 간 Socket.IO 기반 웹소켓 연결을 구성하는 과정을 정리한다.
track: log
created: 2024-09-25T09:39
tags: [websocket, socketio, nestjs]
---

Node.js 환경에서는 웹소켓을 직접 구현할 수 있지만, 간편성, 성능, 보안 등의 이점으로 전용 라이브러리를 주로 사용한다. 그중 가장 보편적인 **Socket.IO** 라이브러리를 이용해 구현할 예정이다.
...
> [!note]
> 해당 문서에서 작업하는 Nest.js의 버전은 `@nestjs/core@10.0.0`이다.
...
> [!note]
> 해당 문서에서 작업하는 Next.js의 버전은 `next@14.2.6`이다.
