---
title: Nest.js 유효성 검사 — Validation Pipe와 class-validator
description: Nest.js의 ValidationPipe와 class-validator를 이용해 요청 데이터의 유효성을 전역으로 검증하는 방법을 정리한다.
track: notes
created: 2024-01-05T09:00
tags: [nestjs, validation-pipe, class-validator]
---
...
> 데이터를 객체의 형태로 변환하는 데 사용되는 클래스로, 주로 데이터를 전달할 때 사용되는 것에 초점을 맞춘 개념이지만 요청 데이터 유효성 검사의 기준으로도 함께 사용된다.
...
![ValidationPipe 유효성 검사 실패 시 400 응답](/assets/images/blog/6/1.png)
