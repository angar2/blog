---
title: 포트 포워딩
description: 홈서버 구축 과정에서 라우터의 포트 포워딩 설정으로 외부 요청을 내부 서버로 전달하는 방법을 정리한다.
track: log
created: 2024-10-30T09:56
tags: [home-server, port-forwarding, network]
---
...
![포트 포워딩 설정 화면](/assets/images/blog/56/1.png)

위와 같이 포트 포워딩할 **포트 번호**와 **내부 IP 주소**를 입력한 후 `추가` 버튼을 클릭해 설정을 등록한다.

![포트 포워딩 등록 화면](/assets/images/blog/56/2.png)
