---
title: Nest.js API 문서화 — Swagger Module
description: Nest.js 프로젝트에서 SwaggerModule로 API 문서를 자동 생성하고, Controller와 DTO 데코레이터로 문서 내용을 채우는 방법을 정리한다.
track: notes
created: 2024-01-06T09:00
tags: [nestjs, swagger]
sources:
  - title: Nest.js Swagger(OpenAPI) 공식 문서
...
> [!tip]
> [Nest.js Swagger(OpenAPI) 공식 문서](https://docs.nestjs.com/openapi/introduction)
...
![Swagger](/assets/images/blog/7/1.png)
...
![Swagger](/assets/images/blog/7/2.png)
