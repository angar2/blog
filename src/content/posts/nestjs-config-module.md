---
title: Nest.js 환경 변수 관리 — Config Module
description: NestJS 공식 ConfigModule을 이용해 환경변수를 분리·관리하는 이유와 설정 방법, 그리고 ConfigService로 환경변수를 불러와 활용하는 방법을 정리한다.
track: notes
created: 2024-01-07T09:00
tags: [nestjs, config]
sources:
  - title: Documentation | NestJS
...
> [!tip]
> [Documentation | NestJS](https://docs.nestjs.com/techniques/configuration)
