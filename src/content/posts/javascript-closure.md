---
title: 자바스크립트 클로저와 가비지 컬렉션
description: 클로저가 발생하는 원리와 LexicalEnvironment가 가비지 컬렉션 대상에서 제외되는 이유를 정리하고, 참조 카운트를 이용해 클로저로 인한 메모리 누수를 해결하는 방법과 활용 사례를 살펴본다.
track: notes
created: 2024-07-06T09:26
tags: [javascript, closure, garbage-collection]
---
...
![클로저 현상 예시](/assets/images/blog/26/1.png)
...
클로저가 실무에서 활용되는 대표적인 사례는 다음과 같다.
