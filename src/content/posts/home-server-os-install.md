---
title: 운영체제 선택과 설치
description: 홈서버로 활용할 노트북에 Windows와 Ubuntu를 함께 운영하기로 하고, 데스크톱 버전을 선택한 이유와 설치 과정 개요를 정리한다.
track: log
created: 2024-10-09T09:45
tags: [home-server, ubuntu, linux]
sources:
  - title: ubuntu 데스크탑과 서버 커널의 차이점은?
    url: https://www.morenice.kr/119
  - title: '[우분투] 데스크탑 버전에서 서버 버전으로 변경'
    url: https://hanryang1125.tistory.com/66
---
