---
title: 'I am Ironman: 콘텐츠 모션과 애니메이션'
description: Phaser.js 게임에서 캐릭터 모드별 이미지 교체로 애니메이션을 구현하고, 방향키·특정 키 입력에 따른 이동과 공격 모션 로직을 정리한다.
track: log
created: 2024-08-18T09:33
tags: [phaser, animation, game]
sources:
...
![아이언맨 모드 변경(5)](/assets/images/blog/33/1.gif)
![울트론 모드 변경(2)](/assets/images/blog/33/2.gif)
![울트론2 모드 변경(2)](/assets/images/blog/33/3.gif)
...
![리펄서 발사](/assets/images/blog/33/4.gif)
![유니빔 발사](/assets/images/blog/33/5.gif)
![울트론 리펄서 발사](/assets/images/blog/33/6.gif)
</content>
</invoke>
