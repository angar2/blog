---
title: Nest.js Decorator 동작원리와 종류, Custom Decorator
description: Nest.js에서 데코레이터가 동작하는 원리와 클래스/메소드 수준의 주요 내장 데코레이터 종류를 정리하고, 전역 Guard 예외 처리를 위해 커스텀 데코레이터를 직접 만들어 문제를 해결한 경험을 기록한다.
track: notes
created: 2024-01-01T09:00
tags: [nestjs, decorator]
sources:
  - title: 타입스크립트 @데코레이터 개념 & 사용법
    url: https://inpa.tistory.com/entry/TS-📘-타입스크립트-데코레이터-개념-사용법-정리
---
...
**먼저 적용해야하는 데코레이터일 수록 아래에 배치해야함**을 의미한다.
