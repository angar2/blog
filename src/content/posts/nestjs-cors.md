---
title: Nest.js CORS 설정
description: 프론트엔드와 협업 개발 시 CORS가 필요한 이유와 Nest.js의 enableCors() 메소드를 이용한 CORS 설정 방법을 정리한다.
track: notes
created: 2024-01-04T09:00
tags: [nestjs, cors]
---
...
> [!note]
> **CORS(Cross-Origin Resource Sharing: 교차 출처 리소스 공유)** 이란, 애플리케이션이 다른 출처(도메인, 프로토콜, 포트)의 리소스에 접근하는 것을 허용하는 메커니즘.
