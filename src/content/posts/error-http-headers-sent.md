---
title: ERR_HTTP_HEADERS_SENT - HTTP 응답 후 수정 시도 문제 해결
description: Nest.js 인터셉터에서 응답을 중복 반환해 발생한 ERR_HTTP_HEADERS_SENT 에러의 원인과 해결 과정을 정리한다.
track: log
created: 2024-01-16T09:18
tags: [error, nodejs, express]
---
...
문제의 원인은 인터셉터로 설정해둔 미들웨어의 로직에 있었다.
...
원인이 된 로직을 파악했으므로 아래와 같이 코드를 수정해 문제를 해결했다.
