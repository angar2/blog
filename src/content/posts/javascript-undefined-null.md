---
title: 자바스크립트 undefined와 null
description: 값을 지정할 것으로 예상되는 상황에서 지정되지 않았을 때 반환되는 undefined의 발생 케이스와, 명시적으로 없음을 표현하기 위한 null의 쓰임을 정리한다.
track: notes
created: 2024-07-01T09:19
tags: [javascript]
---
