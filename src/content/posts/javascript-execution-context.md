...
description: 자바스크립트 엔진이 코드를 실행하기 위해 참조하는 실행 컨텍스트의 개념과 생성 과정, 그리고 내부에 저장되는 환경 정보를 정리한다.
track: notes
created: 2024-07-02T09:20
...
![콜스택에 실행 컨텍스트가 쌓였다가 제거되는 과정](/assets/images/blog/20/1.jpeg)
...
실행 컨텍스트가 생성될 때 내부에는 아래와 같은 환경 정보가 함께 수집된다.

![실행 컨텍스트 내부에 저장되는 VariableEnvironment, LexicalEnvironment, ThisBinding 구조](/assets/images/blog/20/2.png)
