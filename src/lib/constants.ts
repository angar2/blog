...
export const HOME_OG_IMAGE_URL = '/assets/images/og.jpg';
export const LOGO_IMAGE_URL = '/assets/images/logo.png';
export const MAIN_BANNER_IMAGE_URL = '/assets/images/main/banner.png';
export const MAIN_ARROW_IMAGE_URL = '/assets/images/main/arrow.png';
export const EXPERIENCE_BANNER_IMAGE_URL =
