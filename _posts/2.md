---
title: 'Nest.js: 주요 기능 I | Decorator 동작원리와 종류, Custom Decorator'
excerpt: 'Nest.js의 주요 기능 중에는 **Decorator**가 있다. 그간 사용해 오면서 “`@`가 붙은 어떤 기능” 정도로만 알고 있었는데, 생각보다 자주, 다양하게, 중요하게 사용되는 기능 중 하나이기에 한번 정리해볼 필요성을 느꼈다. 정리를 통해 **Decorator**의 동작원리를 이해하고 용도별 사용 방법을 구분지어 보자.'
